...
class reduceStress extends StatefulWidget {
  ...
  @override
  _ReduceStressState createState() => _ReduceStressState();
}
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset(
                    'assets/images/reducestress1.png',
                    width: 500, // Adjust the width of the image
                    height: 205, // Adjust the height of the image
                  ),
                  // Texts
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 10),
                        const Text(
                          'Just take a moment to think of a goal that requires both action and planning, this aim applies to all tasks.',
                          style: TextStyle(
                            fontSize: 16,
                            color: Color(0xFFAA77FF),
                          ),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              buildButton('Meditation', Icons.self_improvement),
                              const SizedBox(width: 10),
                              buildButton('Think Positive', Icons.person),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              buildButton('Talk to Friends', Icons.people),
                              const SizedBox(width: 10),
                              buildButton('Outdoor Time', Icons.sports_football),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              buildButton('Go To Nature', Icons.sunny),
                              const SizedBox(width: 10),
                              buildButton('Enough sleep', Icons.bed),
                            ],
                          ),
                        ),
