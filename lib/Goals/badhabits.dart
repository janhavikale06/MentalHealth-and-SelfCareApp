...
class badhabits extends StatefulWidget {
  ...
  @override
  _badhabits createState() => _badhabits();
}

class _badhabits extends State<badhabits> {
  int counter = 0;
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    const Text(
                      'Determine what is limiting your behaviour, redirect your attention, and take control of your actions again.',
                      style: TextStyle(
                        fontSize: 16,
                        color: Color(0xFFAA77FF),
                      ),
