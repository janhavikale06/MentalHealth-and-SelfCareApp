...
import 'package:upliftu/art_therapy/art_therapy.dart';
import 'package:upliftu/exercise/exercise_screen.dart';
import 'package:upliftu/journal/journaling_screen.dart';
import 'package:upliftu/meditation/meditation_screen.dart';
import 'package:upliftu/mental_health_pages/music_screen.dart';
import 'package:upliftu/mental_health_pages/open_share_circle.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _buildActivityCard(
            ...
            description: 'Discover the impact of open dialogue among individuals facing\nsimilar challenges.',
            context: context,
          ),
          const SizedBox(height:2),
          _buildActivityCard(
            title: 'Art Therapy',
            description: 'Self-expression and healing through art can be achieved\nthrough art.',
            context: context,
          ),
        ],
      ),
