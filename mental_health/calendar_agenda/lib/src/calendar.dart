                            ...
                            child: Row(
                              children: [
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.arrow_left), // Icon for left arrow
                                    SizedBox(width: 8.0), // Adjust the space between the arrow and the month text
                                    Text(
                                      DateFormat.yMMMM(Locale(_locale).toString()).format(_selectedDate!),
                                      style: TextStyle(
                                      fontSize: 18.0,
                                      color: widget.monthColor ?? widget.dateColor, // Apply monthColor or default to dateColor
                                      fontWeight: FontWeight.bold, // Set the fontWeight to bold for the month
                                      ),
                                      textAlign: TextAlign.center,
                                    ),
                                    SizedBox(width: 8.0), // Adjust the space between the month text and the right arrow
                                    Icon(Icons.arrow_right), // Icon for right arrow
                                  ],
                                ),
                              ],
                            ),
